    ...
    while True:
        ...
        for i in range(len(B)): #Отримуємо доступ до елементів матриці B.
            try: #Перевірка на входження чисел.
                B[i] =int(input('Введіть елементи масиву: '))
                continue
            except ValueError:
                print('Input numbers!! ')
                break

        A=sorted(B)#Відсортуємо елементи матриці В, щоб всі повторювальні\
        #елементи йшли підряд.
        ...
        lst_common=lst+lst1 #Зробимо конкатенацію списків, аби знайти у них максимальну
